...
import bgu.spl181.net.api.bidi.ConnectionsImplement;
...
public interface Server<T> extends Closeable {
    ...
    public static <T> Server<T>  threadPerClient(
        ...
        return new BaseServer<T>(port, protocolFactory, encoderDecoderFactory,new ConnectionsImplement<T>() {
        }) {
            @Override
    ...
    public static <T> Server<T> reactor(
            ...
            Supplier<BidiMessagingProtocol<T>> protocolFactory,
            Supplier<MessageEncoderDecoder<T>> encoderDecoderFactory) {
        return new Reactor<T>(nthreads, port, protocolFactory, encoderDecoderFactory,new ConnectionsImplement<T>());
    }
